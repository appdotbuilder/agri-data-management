 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\PestDetection> $verifications
...
class User extends Authenticatable
{
    ...
    /**
     * Get the district that the user is assigned to.
     */
    ...
    /**
     * Get the pest detections created by the user.
     */
    ...
    /**
     * Get the pest detections verified by the user.
     */
    public function verifications(): HasMany
    {
        return $this->hasMany(PestDetection::class, 'verified_by');
    }
